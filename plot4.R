...
plot4 <- function(){
  ...
  #draw 2nd graph
  with(df.data,plot(Voltage ~ datetime,
       #col="red",
       #ylab="Voltage",
       #xlab="datetime",
       type="n",
       main=""))
  with(df.data,lines(Voltage ~ datetime))
  ...
  #draw 4th graph
  with(df.data, plot(Global_reactive_power ~ datetime,
       #col="red",
       #ylab="Voltage",
       #xlab="datetime",
       type="n",
       main=""))
  with(df.data,lines(Global_reactive_power ~ datetime))
